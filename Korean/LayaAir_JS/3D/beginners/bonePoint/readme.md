...
그림 4 마법 공격 효과 에 따라 두 종류 를 통해 실현 할 수 있다. 하나 는 주류 La3Du Bonpoint.js 로 애니메이션 재생 과 생성 마법 무기 를 실현 할 수 있다: 공격 애니메이션 에서 36 프레임 을 방영 할 때 에는 압정 무기 와 같은 신마법 무기 를 추출 무기 를 첨가해 무기를 비행, 원시 에 무기 를 잠시 감추고, 애니메이션 이 완료 된 뒤다시 보기로 모의는 마법이 생기고 마법의 효과를 던진다.
