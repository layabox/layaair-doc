...
Crée une nouvelle catégorie de fichiers, myshadervalue.js, sous le catalogue src / Shader, pour établir une catégorie de variables pour les programmes de colorants.
