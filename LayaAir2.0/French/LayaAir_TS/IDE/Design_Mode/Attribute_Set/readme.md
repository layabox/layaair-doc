...
`centerX、centerY`Les deux propriétés sont utilisées principalement pour adapter le composant à la position centrale du récipient parent.
...
![图片1.png](img/5-1.png)< br / > (Figure 5 - 1)
