...
![动图14-3](img/14-3.gif)< br / > (Figure 14 - 3)
...
![动图16-4](img/16-4.gif)< br / > (figures 16 à 4)
...
On va en créer un.`TimeLine.scene`Sur la page ui, puis faites glisser directement`planCrashed.ani`Dans la scène, comme le montre la figure 32.
