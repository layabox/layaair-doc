...
In the front**Play animation**In this section, we simply use animatorstate animation state. He can specify the animation to play a frame to a frame, and can create additional animation clips (fragments) on the basis of the original animation. In this section, we explain the animation state in detail.
