...
Drag the background image that has just been set to Jiugong grid to the scene editor. As shown in Figure 2-2.
...
Save the page and press F12 to publish the page. After publishing, ComponentDemoUI.as class is generated in the project UI folder. We use it directly.



Create ComponentDemo. as and set the default program, write the following code:
